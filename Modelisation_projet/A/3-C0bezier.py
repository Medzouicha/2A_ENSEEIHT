...
control_points = {
    ...
    (0, 3, 0): np.array([0, 10, 2]),
    (1, 0, 2): np.array([10/3, 0, 7.5]),
    (1, 1, 1): np.array([10/3, 10/3, 2]),
    (1, 2, 0): np.array([4, 6, 8]),
    (2, 0, 1): np.array([20/3, 0, 4]),
    (2, 1, 0): np.array([6, 4, 7]),
    (3, 0, 0): np.array([10, 0, 5]),
}

# Generate the second set but witht the points on the edge equal to the first set 
second_control_points = {
    (0, 0, 3): np.array([11, 11, 10]),
    (0, 1, 2): np.array([20/3, 11, 2]),
    (0, 2, 1): np.array([10/3, 11, 2]),
    (0, 3, 0): control_points[(0,3,0)], #Same as the control points of the first set
    (1, 0, 2): np.array([10, 20/3, 7.5]),
    (1, 1, 1): np.array([22/3, 22/3, 2]),
    (1, 2, 0): control_points[(2,1,0)], #Same as the control points of the first set
    (2, 0, 1): np.array([8, 4, 3]),
    (2, 1, 0): control_points[(1,2,0)],  #Same as the control points of the first set
    (3, 0, 0): control_points[(3,0,0)], #Same as the control points of the first set
}
...
ax.set_title('Two Stitched Bézier Surfaces (with continuity)')
ax.set_xlabel('X')
ax.set_ylabel('Y')
ax.set_zlabel('Z')
